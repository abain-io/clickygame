React App - clickygame is a game where you click on a Pic (an image) to gain points, but if you click on an image that you previously clicked on, it will start again. Good luck! -Andrew Bain
